        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div className="relative group overflow-hidden rounded-xs border border-[#24292E] bg-[#0B0D0F] min-h-[460px] sm:min-h-[520px] flex flex-col justify-end p-8 sm:p-12">
            ...
            <div className="relative z-10 space-y-4">
              ...
              <div className="pt-2">
                <button
                  onClick={() => openWhatsApp("Olá! Gostaria de solicitar um orçamento para meu projeto Residencial.")}
          ...
          <div className="relative group overflow-hidden rounded-xs border border-[#24292E] bg-[#0B0D0F] min-h-[460px] sm:min-h-[520px] flex flex-col justify-end p-8 sm:p-12">
            ...
            <div className="relative z-10 space-y-4">
              ...
              <div className="pt-2">
                <button
                  onClick={() => openWhatsApp("Olá! Gostaria de solicitar um orçamento para meu projeto Corporativo.")}
